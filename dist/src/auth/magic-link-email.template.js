...
exports.magicLinkEmailHtml = magicLinkEmailHtml;
exports.magicLinkEmailText = magicLinkEmailText;
function magicLinkEmailHtml(params) {
    ...
    const muted = '#64748b';
    const text = '#cbd5e1';
    const badgeBg = '#111a3a';
    const badgeBorder = '#2b335a';
    const infoBg = '#0f172a';
...
function magicLinkEmailText(params) {
    const brand = params.brandName ?? 'LinkSy';
...
//# sourceMappingURL=magic-link-email.template.js.map