...
exports.waitlistEmailText = waitlistEmailText;
function waitlistEmailHtml(params) {
    const brand = params.brandName ?? 'LinkSy';
    const domain = params.domain ?? 'linksy.dev';
    const ctaUrl = params.ctaUrl ?? 'https://linksy.dev/#how';
    const preheader = 'تم تأكيد إدراجك في قائمة الانتظار. سنرسل لك الدعوة فور فتح دفعة جديدة.';
    return `<!doctype html>
...
//# sourceMappingURL=waitlist-email.template.js.map